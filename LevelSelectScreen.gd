...
onready var level_names = [
	$CanvasLayer/TextureRect/VBoxContainer/CenterContainer/HBoxContainer/Level1/MarginContainer/LevelName,
	$CanvasLayer/TextureRect/VBoxContainer/CenterContainer/HBoxContainer/Level2/MarginContainer/LevelName,
	$CanvasLayer/TextureRect/VBoxContainer/CenterContainer/HBoxContainer/Level3/MarginContainer/LevelName,
	$CanvasLayer/TextureRect/VBoxContainer/CenterContainer/HBoxContainer/Level4/MarginContainer/LevelName
...
func _on_LevelButton_pressed(level_number):
	...
	curse_name_box.set_text("Curse: %s" % GameData.get_curse_name(level_data[level_number-1]["curse"]))
